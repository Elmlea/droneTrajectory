...
def projectile_trajectory(v0, m, initial_y, diameter, dt):
    # Constants
    k = 0.24 * np.pi * (diameter / 2)**2  # Drag constant
...
def calculate_trajectory():
    ...
    x_values, y_values, kinetic_energy = projectile_trajectory(v0, m, initial_y, diameter, dt)
...
label_diameter = Label(root, text="Diameter (m):")
label_diameter.pack()
entry_diameter = Entry(root)
entry_diameter.pack()
